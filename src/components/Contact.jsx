...
export default function Contact() {
  ...
  if (typeof window !== 'undefined') {
    window.addEventListener('scroll', () => {
      if (window.scrollY > 600 && !scrollVisible) setScrollVisible(true);
      if (window.scrollY <= 600 && scrollVisible) setScrollVisible(false);
    });
  }
    ...
    <section className="section contact" id="contact">
      <div className="container">
        ...
        <div className="contact-layout">
          ...
          <form className="contact-form" data-reveal="true" action="https://formspree.io/f/YOUR_FORM_ID" method="POST">
            ...
            <div className="form-group">
              <textarea name="message" placeholder="Your Message..." required rows="4" className="form-input form-textarea"></textarea>
            </div>
